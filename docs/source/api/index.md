...
| Area | Objects |
| --- | --- |
| {doc}`Operations <operations>` | {func}`~scorch.matmul`, {func}`~scorch.einsum`, {func}`~scorch.sparse_linear`, {func}`~scorch.sparse_linear_fm`, {func}`~scorch.sparse_attention`, {func}`~scorch.sparse_softmax_csr`, {func}`~scorch.fast_transpose`, {func}`~scorch.precompile_kernels` |
