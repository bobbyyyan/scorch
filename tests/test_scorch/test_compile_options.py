...
def test_compressed_output_discovers_positions_without_private_renderers(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    ...
    assert cpp
    # Structured result stores and position discovery no longer instantiate
    # private spelling renderers. Only the requested final C++ emission remains.
