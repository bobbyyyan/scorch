...
from tests.test_scorch.codegen.test_1d_operations import *

# Import 2D tensor tests
from tests.test_scorch.codegen.test_2d_operations import *

# Import matrix multiplication tests
from tests.test_scorch.codegen.test_matmul_operations import *

# Import higher-dimensional tensor tests
from tests.test_scorch.codegen.test_higher_dim_operations import *
